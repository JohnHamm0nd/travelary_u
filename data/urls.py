...
urlpatterns = [
    ...
    path('<int:data_id>/reviewupdate/<int:user_id>', views.ReviewUpdate.as_view(), name='reviewupdate'),
    path('<int:data_id>/reviewdelete/<int:user_id>', views.ReviewDelete.as_view(), name='reviewdelete'),
